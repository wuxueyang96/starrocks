...
std::vector<uint8_t> NewPForDeltaEncoder::encode(const std::vector<uint32_t>& values) {
...
std::vector<uint32_t> NewPForDeltaEncoder::decode(const std::vector<uint8_t>& encoded) {
